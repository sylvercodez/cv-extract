                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Image</label>
                            <input type="file" name="image" id="image" class="ace-file form-control input-sm" />
                        </div>
                    </div>
					<div class="col-md-6">
                        <div class="form-group">
                            <label>Html</label>
                            <input type="file" name="html" id="html" class="ace-file form-control input-sm" />
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="content-wrapper">
        	<div class="<?php echo CONTAINER; ?>">
        		...
        		<section class="content-header">
        			<h1><i class="fa fa-list-alt"></i> User</h1>
        			<ol class="breadcrumb">
        				<li><a href="#"><i class="fa fa-list-alt"></i> User</a></li>
        			</ol>
        		</section>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var table = $("#data-table").on( 'init.dt', function () {
                    ...
                    "order": [[ 1, "asc" ]],
                    "ajax": {
                        url: '<?php echo site_url('admin/User/select'); ?>',
                        type: 'GET',
                        "data": {
                            "action": "view"
                        }
