...
<?php
    if($action=='add'||$action=='edit'){
        echo form_open_multipart('#',array('class'=>'form-validate','name'=>'degreeForm','id'=>'degreeForm'));
        ?>
        <div class="box box-default">
            <div class="box-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="box-title" id="myModalLabel"><?php echo $id>0?$name:'Add Degree'; ?></h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php echo form_input(array('id'=>'name','name'=>'name', 'value'=>$name,'class'=>'form-control','required'=>true)); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            $(document).ready(function(){
                ...
                $(".form-validate").submit(function(e){
                    ...
                    if($(".form-validate").validate().errorList.length==0){
                        $('.overlay').toggle();
                        var url = '<?php echo base_url('admin/Degree/save'); ?>'
                        $.ajax({
                            type: "POST",
                            url: url,
                            ...
                            success: function(data){
                                ...
                                if(result['status']==1){
                                    $('#degreeForm')[0].reset();
                                    $('#degreeForm .remove').trigger('click');
        ...
        <div class="content-wrapper">
        	<div class="<?php echo CONTAINER; ?>">
        		...
        		<section class="content-header">
        			<h1><i class="fa fa-list-alt"></i> Degree</h1>
        			<ol class="breadcrumb">
        				<li><a href="#"><i class="fa fa-list-alt"></i> Degree</a></li>
        			</ol>
        		</section>
        			...
        			<div class="box box-default">
        				<div class="box-header with-border">
        					...
        					<div class="box-tools pull-right">
                                <a href="<?php echo base_url('admin/Degree/add'); ?>" data-remote="false" data-toggle="modal" data-target="#myModal" class="ico edit">Add Record</a>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var table = $("#data-table").on( 'init.dt', function () {
                    ...
                    "order": [[ 1, "asc" ]],
                    "ajax": {
                        url: '<?php echo site_url('admin/Degree/select'); ?>',
                        type: 'GET',
                        "data": {
                            "action": "view"
                        }
                    ...
                    bootbox.confirm({
                        ...
                        callback: function (result) {
                            if(result===true){
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: '<?php echo site_url('admin/Degree/delete'); ?>',
                                    data: data,
                                    cache: false,
                                    success: function(data){
                ...
                $(document).delegate('.btn-status', 'click', function() { 
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo site_url('admin/Degree/status'); ?>',
                        data: data,
                        cache: false,
                        success: function(data){
                            data = JSON.parse(data);
