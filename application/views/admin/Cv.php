    ...
    if($action=='add'||$action=='edit'){
        ...
        <div class="box box-default">
            ...
            <div class="box-footer">
                ...
                <span class="pull-right"><a href="<?= $id>0 ? base_url('admin/cv/editor/'. $id) : base_url('admin/cv/editor/') ?>" style="color: #428bca;"><strong>Open Custom Editor</strong> </a></span>
            </div>
        </div>
        <?php echo form_close();?>
        ...
        <div class="content-wrapper">
        	<div class="<?php echo CONTAINER; ?>">
        		...
        		<section class="content-header">
        			<h1><i class="fa fa-list-alt"></i> CV</h1>
        			<ol class="breadcrumb">
        				<li><a href="#"><i class="fa fa-list-alt"></i> CV</a></li>
        			</ol>
        		</section>
