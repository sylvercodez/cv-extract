    ...
    <article class="resume-wrapper text-center position-relative">
	    <div class="resume-wrapper-inner mx-auto text-left bg-white shadow-lg">
			...
			<div class="row" style="margin: 0px !important;">
				<div class="mr-3 img-fluid picture mx-auto">
				    <img class="img img-responsive" src="<?= base_url('uploads/'.$image); ?>" alt="" style="max-width: 100%; max-height: 100%;">
				</div>
					<div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0" style="min-width: 75% !important;">
					    <div class="primary-info" style="display: block;">
