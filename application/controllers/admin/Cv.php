    ...
    class Cv extends CI_Controller {
        ...
        */
        ...
        public function add(){
            ...
            $this->load->view('admin/Cv',$data,false);
        }
        ...
        public function view($cv_id){
            ...
            // var_dump($cv);
            $this->load->view('cvs/'. $cv->html, $data);
        }
        ...
        public function editor($id = false){
            ...
            if (!$this->form_validation->run()){
                // $this->load->newAdmin('createPage', $data);
                $this->load->newAdmin('createPage', $data);
            }else{
                $this->load->newAdmin('createPage', $data);
            }
        ...
        public function test(){
            ...
            // $data = array(
            //     'navigation' => array(
            //         array('href'=> 'http://www.google.com', 'caption'=> 'Heres ypur google'),
            //         array('href'=> 'http://www.twitter.com', 'caption'=> 'Heres ypur twitter'),
            //     ),
            //     'a_variable' => 'Kira Kosarin',
            // );
            // $this->twig->display('twig_welcome', $data);
            // $this->load->library('editor');
